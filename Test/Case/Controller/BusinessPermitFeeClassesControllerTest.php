<?php
App::uses('BusinessPermitFeeClassesController', 'Controller');

/**
 * BusinessPermitFeeClassesController Test Case
 *
 */
class BusinessPermitFeeClassesControllerTest extends ControllerTestCase {
