<?php
App::uses('BusinessTaxClassesController', 'Controller');

/**
 * BusinessTaxClassesController Test Case
 *
 */
class BusinessTaxClassesControllerTest extends ControllerTestCase {
