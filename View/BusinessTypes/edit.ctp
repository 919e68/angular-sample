<div class="modal-dialog">
	<div class="modal-content">
		...
		<?php echo $this->Form->create('BusinessType', array('url'=>array('controller'=>'business_types', 'action'=>'create'), 'role'=>'form', 'class'=>'ajax-form', 'inputDefaults'=>array('label'=>false, 'div'=>false, 'class'=>'form-control' ))) ?>
        ...
        $.ajax({
            ...
            success:function (data) {
            	if(data.response == 'success') {
					...
					angular.element($('[ng-controller="BusinessType"]')).scope().load();
            	} else {
