<div>
    <div class="panel panel-default">
        <div class="panel-heading"><i class="fa fa-dot-circle-o"></i> BUSINESS PERMIT REQUIREMENTS</div>
				...
				<table class="table table-bordered table-striped table-hover center vcenter">
					...
					<tbody>
						<tr ng-repeat="data in datas">
							<td class="uppercase text-left">{{ data.BusinessPermitRequirement.name }}</td>
							<td>{{ data.BusinessPermitRequirement.description }}</td>
							<td>
