<div>
    <div class="panel panel-default">
        <div class="panel-heading"><i class="fa fa-dot-circle-o"></i> BUSINESS ASSET TYPES</div>
				...
				<table class="table table-bordered table-striped table-hover center vcenter">
					...
					<tbody>
						<tr ng-repeat="data in datas">
							<td class="uppercase text-left">{{ data.BusinessAssetType.name }}</td>
							<td class="text-left">{{ data.BusinessAssetType.description }}</td>
							<td>
